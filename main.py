...
"""
⚡ ASHMIT'S CPM STORE - ULTIMATE ENGINE ⚡
"""
...
@app.route('/')
def home(): return jsonify({"status": "Ashmit's CPM Store Online"})
...
# 🤖 BOT INIT
# ═══════════════════════════════════════════════════════════
BOT_TOKEN = '8716832791:AAEJEOKDshyQVBs-eEt-0pvndtKPiB-dOW8'
...
if __name__ == "__main__":
    print("="*60)
    print("⚡ ASHMIT'S CPM STORE - ULTIMATE ENGINE ONLINE ⚡")
    print("="*60)
    while True:
        try:
